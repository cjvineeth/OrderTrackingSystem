...
public class LetterImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getDrawable() == null) {
            ...
            mTextPaint.setTextSize(canvas.getHeight() - getTextPadding()*4);
            if (isOval()) {
            ...
            float textWidth = mTextPaint.measureText(mLetter);
            float textHeight = textBounds.height();
            // Draw the text
            canvas.drawText(mLetter, canvas.getWidth() / 2f - textWidth / 2f,
